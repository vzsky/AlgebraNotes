...
\newcommand{\exmp}[3][]{
  \begin{example}{#2}{#1}#3\end{example}
}

\newcommand{\exc}[3][]{
  \begin{exercise}{#2}{#1}#3\end{exercise}
}
...
{%
	...
	frame hidden,
	boxrule = 0sp,
	borderline west = {2pt}{0pt}{myexmp},
	sharp corners,
	detach title,
  before upper={\setlength{\parskip}{5pt}\tcbtitle\par\smallskip},
	coltitle = myexmp,
	...
	description font = \mdseries,
	separator sign none,
	segmentation style={solid, myexmp},
}{exmp}
...
\newtcbtheorem{exercise}{Exercise}{enhanced,
	...
	underlay boxed title={%
			\path[fill=myexc] (title.south west)--(title.south east)
			to[out=0, in=180] ([xshift=5mm]title.east)--
			(title.center-|frame.east)
			[rounded corners=\kvtcb@arc] |-
			(frame.north) -| cycle;
